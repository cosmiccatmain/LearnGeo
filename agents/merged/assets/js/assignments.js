...
(function (global) {
  ...
  function complete(a, pct, correct, total, missed) {
    ...
    /* last is the attempt that counts: it is what goes to the teacher, so it
       is what the student's Grades panel and the gradebook both show. best is
       kept as a personal record and for saves written before that was true. */
