...
(function (global) {
  ...
  function signature(opts) {
    ...
    Object.keys(m).forEach(function (k) {
      ...
      var lit = m[k].box >= 4;
      if (lit) done += 1;
      /* Counts alone are not the picture: one country dropping out of box 4
         as another arrives leaves seen and done untouched while two shapes
         change colour. Fold in which ones, cheaply. */
      var s = k + (lit ? '!' : '.');
